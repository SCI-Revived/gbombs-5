...
CreateConVar("gb5_player_damage_scale", "0.5", { FCVAR_REPLICATED, FCVAR_ARCHIVE, FCVAR_NOTIFY } )
CreateConVar("gb5_prop_damage_scale", "1", { FCVAR_REPLICATED, FCVAR_ARCHIVE, FCVAR_NOTIFY } )