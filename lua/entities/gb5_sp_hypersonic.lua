...
function ENT:Explode()
	...
	local Shockwave = gb5BeginShockwave() do
		...
		Shockwave.Sound              = "gbombs_5/explosions/special/hypersonic.mp3"
	gb5CommitShockwave() end

	local Shockwave = gb5BeginShockwave() do
		Shockwave.Class              = "gb5_shockwave_ent_dir_vec"
		Shockwave.Origin             = pos
		Shockwave.PropForce          = 600
		Shockwave.PlyForce           = 800
		Shockwave.PlyAirForce        = 300
		Shockwave.Attacker           = self.GBOWNER
	...
	if(self:WaterLevel() >= 1) then
		...
		if trace.HitWorld then
			ParticleEffect("hypersonic",pos,angle_zero,nil)	
